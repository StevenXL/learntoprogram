require_relative "expanded_english"
...
while (initial_beers > 0)
    ...
    # the program
    line_1_and_2 = "\t#{english_number(initial_beers)} bottles of beer on the wall,\n\t#{english_number(initial_beers)} bottles of beer!\n"
    line_3 = "\tYou take one down, pass it around,\n"
    line_4 = "\t#{english_number(initial_beers - 1)} bottles of beer on the wall!\n"
